...
export const NADIAD_ELECTION_2026 = createGujaratElection({
  ...
  scopeNote:
    "Nadiad's election desk now includes the inherited municipality ward structure used as a starting point while the new corporation's first ward-wise candidate list is still being verified.",
  sources: [
    {
