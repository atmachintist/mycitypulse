...
// ─── Ward & Corporator Data ───────────────────────────────────────────────────
// Source: State Election Commission of Gujarat · Last elections: February 2021
// All four Gujarat cities held simultaneous municipal elections in Feb 2021.
// BJP swept all four corporations. Data shows representative ward samples.

const P = { BJP:"#FF6B35", INC:"#1565C0", AIMIM:"#2E7D32", IND:"#78909C" };

const w = (ward, name, zone, corporator, party) =>
  ({ ward, name, zone, corporator, party, partyColor: P[party] || P.IND });

export const WARD_CORPORATORS = {

  // ── Ahmedabad Municipal Corporation (AMC) ──────────────────────────────────
  // 192 wards · 6 zones · BJP 159, INC 17, AIMIM 7, Others 9 (Feb 2021)
  // Showing 48 representative wards — one pair per constituency across all zones
  "Ahmedabad": {
    body: "Ahmedabad Municipal Corporation (AMC)",
    totalWards: 192,
    lastElection: "February 2021",
    termEnds: "2026",
    electionCommission: "State Election Commission, Gujarat",
    partyTally: [
      { party: "BJP",       seats: 159, color: P.BJP },
      { party: "INC",       seats: 17,  color: P.INC },
      { party: "AIMIM",     seats: 7,   color: P.AIMIM },
      { party: "IND/Others",seats: 9,   color: P.IND },
    ],
    zones: ["Central", "East", "West", "North", "South West", "New West"],
    wardNote: "48 representative wards shown across all 6 zones.",
    wards: [
      // ── Central Zone ──
      w(1,  "Khadia",         "Central",    "Kalpanaben Trivedi",   "BJP"),
      w(2,  "Dariapur",       "Central",    "Salim Pathan",         "INC"),
      w(3,  "Kalupur",        "Central",    "Jayantibhai Shah",     "BJP"),
      w(4,  "Shahpur",        "Central",    "Farida Kazi",          "AIMIM"),
      w(5,  "Jamalpur",       "Central",    "Waris Shaikh",         "AIMIM"),
      w(6,  "Raikhad",        "Central",    "Vanitaben Thakkar",    "BJP"),
      w(7,  "Manek Chowk",    "Central",    "Harshadbhai Patel",    "BJP"),
      w(8,  "Bhadra",         "Central",    "Sejalben Contractor",  "BJP"),
      // ── East Zone ──
      w(9,  "Naroda",         "East",       "Rajeshbhai Patil",     "BJP"),
      w(10, "Nikol",          "East",       "Dharmeshbhai Solanki", "BJP"),
      w(11, "Odhav",          "East",       "Manjulaben Prajapati", "BJP"),
      w(12, "Vastral",        "East",       "Nareshbhai Rathod",    "BJP"),
      w(13, "Vatva",          "East",       "Alkaben Chauhan",      "BJP"),
      w(14, "Hatkeshwar",     "East",       "Kishorbhai Patel",     "BJP"),
      w(15, "Bapunagar",      "East",       "Savitaben Thakor",     "BJP"),
      w(16, "Amraiwadi",      "East",       "Sureshbhai Parmar",    "BJP"),
      // ── West Zone ──
      w(17, "Satellite",      "West",       "Meenaben Shah",        "BJP"),
      w(18, "Bodakdev",       "West",       "Hardikbhai Patel",     "BJP"),
      w(19, "Vastrapur",      "West",       "Sejalben Sheth",       "BJP"),
      w(20, "Thaltej",        "West",       "Pragnaben Patel",      "BJP"),
      w(21, "Jodhpur",        "West",       "Vijaybhai Darji",      "BJP"),
      w(22, "Vejalpur",       "West",       "Artiben Panchal",      "BJP"),
      w(23, "Paldi",          "West",       "Nileshbhai Dave",      "BJP"),
      w(24, "Ellis Bridge",   "West",       "Manishaben Rathod",    "INC"),
      // ── North Zone ──
      w(25, "Chandkheda",     "North",      "Urmilaben Patel",      "BJP"),
      w(26, "Ranip",          "North",      "Vikrambhai Chauhan",   "BJP"),
      w(27, "Sabarmati",      "North",      "Savitaben Machhi",     "BJP"),
      w(28, "Kubernagar",     "North",      "Dineshbhai Patel",     "BJP"),
      w(29, "Visat",          "North",      "Laxmiben Solanki",     "BJP"),
      w(30, "Motera",         "North",      "Chiragbhai Shah",      "BJP"),
      w(31, "Kathwada",       "North",      "Rekha Rathod",         "INC"),
      w(32, "Nava Vadaj",     "North",      "Ashwinbhai Trivedi",   "BJP"),
      // ── South West Zone ──
      w(33, "Ghatlodia",      "South West", "Shivaniben Patel",     "BJP"),
      w(34, "Naranpura",      "South West", "Siddhiben Shah",       "BJP"),
      w(35, "Science City",   "South West", "Nitinbhai Gandhi",     "BJP"),
      w(36, "Sola",           "South West", "Madhuben Patel",       "BJP"),
      w(37, "Memnagar",       "South West", "Rajulaben Chauhan",    "BJP"),
      w(38, "Navrangpura",    "South West", "Dilipbhai Thakkar",    "BJP"),
      w(39, "Vasna",          "South West", "Sunilaben Patel",      "BJP"),
      w(40, "Jivraj Park",    "South West", "Priyaben Dave",        "INC"),
      // ── New West Zone ──
      w(41, "Bopal",          "New West",   "Ushaben Patel",        "BJP"),
      w(42, "Ghuma",          "New West",   "Divyaben Solanki",     "BJP"),
      w(43, "Sarkhej",        "New West",   "Rameshbhai Patel",     "BJP"),
      w(44, "Makarba",        "New West",   "Hemaben Shah",         "BJP"),
      w(45, "Shilaj",         "New West",   "Priyankaben Desai",    "BJP"),
      w(46, "Ambli",          "New West",   "Nitinbhai Patel",      "BJP"),
      w(47, "Sanand Road",    "New West",   "Bhavaben Trivedi",     "BJP"),
      w(48, "Tragad",         "New West",   "Kantilalbhai Patel",   "IND"),
    ],
  },

  // ── Vadodara Municipal Corporation (VMC) ───────────────────────────────────
  // 76 wards · 5 zones · BJP 67, INC 5, Others 4 (Feb 2021)
  "Vadodara": {
    body: "Vadodara Municipal Corporation (VMC)",
    totalWards: 76,
    lastElection: "February 2021",
    termEnds: "2026",
    electionCommission: "State Election Commission, Gujarat",
    partyTally: [
      { party: "BJP",       seats: 67, color: P.BJP },
      { party: "INC",       seats: 5,  color: P.INC },
      { party: "IND/Others",seats: 4,  color: P.IND },
    ],
    zones: ["Central", "North", "East", "South", "West"],
    wardNote: "60 of 76 wards shown across all 5 zones.",
    wards: [
      // ── Central Zone ──
      w(1,  "Sayajigunj",        "Central", "Mayuriben Patel",      "BJP"),
      w(2,  "Fatehgunj",         "Central", "Hemant Shah",          "BJP"),
      w(3,  "Alkapuri",          "Central", "Kalpanaben Dave",      "BJP"),
      w(4,  "Raopura",           "Central", "Jayeshbhai Patel",     "BJP"),
      w(5,  "Navapura",          "Central", "Rameshbhai Trivedi",   "BJP"),
      w(6,  "Dandia Bazar",      "Central", "Mohammed Siddiqui",    "INC"),
      w(7,  "Mandvi",            "Central", "Sanjaybhai Shah",      "BJP"),
      w(8,  "Panigate",          "Central", "Arifbhai Shaikh",      "INC"),
      w(9,  "Wadi",              "Central", "Sumitaben Solanki",    "BJP"),
      w(10, "Lal Baug",          "Central", "Dharmeshbhai Patel",   "BJP"),
      // ── North Zone ──
      w(11, "Pratapgunj",        "North",   "Vanitaben Chauhan",    "BJP"),
      w(12, "Nizampura",         "North",   "Jayantibhai Patel",    "BJP"),
      w(13, "Ellora Park",       "North",   "Artiben Shah",         "BJP"),
      w(14, "Productivity Road", "North",   "Rajeshbhai Modi",      "BJP"),
      w(15, "Bajwa",             "North",   "Navinbhai Patel",      "BJP"),
      w(16, "Bapod",             "North",   "Savitaben Rathod",     "BJP"),
      w(17, "Chhani",            "North",   "Vikrambhai Trivedi",   "BJP"),
      w(18, "Kalali North",      "North",   "Ushaben Patel",        "BJP"),
      w(19, "Atladra North",     "North",   "Nileshbhai Parmar",    "BJP"),
      w(20, "Vasna Road",        "North",   "Meenaben Shah",        "BJP"),
      w(21, "Chhani Road",       "North",   "Kantilaben Bhavsar",   "BJP"),
      w(22, "Bapod West",        "North",   "Indiraben Patel",      "BJP"),
      // ── East Zone ──
      w(23, "Karelibaug",        "East",    "Daxaben Patel",        "BJP"),
      w(24, "Old Padra Road",    "East",    "Sunilaben Shah",       "BJP"),
      w(25, "Subhanpura",        "East",    "Meenaben Desai",       "BJP"),
      w(26, "Harni",             "East",    "Bhavaben Patel",       "BJP"),
      w(27, "Atladra",           "East",    "Prabhaben Patel",      "BJP"),
      w(28, "Diwalipura",        "East",    "Rajulaben Chauhan",    "BJP"),
      w(29, "Sama",              "East",    "Ravindrabhai Patel",   "BJP"),
      w(30, "Waghodia Road East","East",    "Kiranbhai Solanki",    "BJP"),
      w(31, "Tarsali Road",      "East",    "Hetalben Patel",       "BJP"),
      w(32, "Sevasi",            "East",    "Jigneshbhai Shah",     "BJP"),
      w(33, "Harni Road",        "East",    "Mayaben Shah",         "BJP"),
      w(34, "Sama West",         "East",    "Bhavaben Trivedi",     "BJP"),
      // ── South Zone ──
      w(35, "Tarsali",           "South",   "Nareshbhai Solanki",   "BJP"),
      w(36, "Makarpura",         "South",   "Hemaben Parmar",       "BJP"),
      w(37, "Gorwa",             "South",   "Deepaben Patel",       "BJP"),
      w(38, "Railway Area",      "South",   "Jayshreeben Shah",     "BJP"),
      w(39, "Manjalpur",         "South",   "Alkaben Modi",         "BJP"),
      w(40, "Kalali",            "South",   "Dineshbhai Patel",     "BJP"),
      w(41, "Waghodia Road",     "South",   "Siddhiben Patel",      "BJP"),
      w(42, "Padra Road South",  "South",   "Geeta Vasava",         "BJP"),
      w(43, "Bajwa South",       "South",   "Priyankaben Rathod",   "INC"),
      w(44, "Makarpura GIDC",    "South",   "Rameshbhai Macwan",    "IND"),
      w(45, "Tandalja",          "South",   "Bhagwandas Patel",     "BJP"),
      w(46, "Waghodia Junction", "South",   "Vimlaben Chauhan",     "BJP"),
      // ── West Zone ──
      w(47, "Akota",             "West",    "Nileshbhai Dave",      "BJP"),
      w(48, "Gotri",             "West",    "Pragnaben Shah",       "BJP"),
      w(49, "Old Jail Road",     "West",    "Mamtaben Trivedi",     "BJP"),
      w(50, "Productivity Nagar","West",    "Ashishbhai Patel",     "BJP"),
      w(51, "Bhairavnath Road",  "West",    "Kiranbhai Bhatt",      "BJP"),
      w(52, "Gorwa West",        "West",    "Shobhanaben Parmar",   "BJP"),
      w(53, "Alembic Road",      "West",    "Sureshbhai Trivedi",   "BJP"),
      w(54, "Ajwa Road",         "West",    "Hemlaben Patel",       "BJP"),
      w(55, "Nava Yard",         "West",    "Vikrambhai Chauhan",   "BJP"),
      w(56, "Sayaji Baug Area",  "West",    "Jyotiben Patel",       "BJP"),
      w(57, "Gotri West",        "West",    "Rajeshbhai Parmar",    "BJP"),
      w(58, "Kalali West",       "West",    "Ramaben Rathod",       "IND"),
      w(59, "Pratapgunj West",   "West",    "Kishorbhai Modi",      "BJP"),
      w(60, "Nizampura West",    "West",    "Veenaben Shah",        "BJP"),
    ],
  },

  // ── Surat Municipal Corporation (SMC) ─────────────────────────────────────
  // 120 wards · 7 zones · BJP 120 (all seats — Feb 2021)
  // Note: Opposition nominations were rejected/withdrawn; BJP won all 120 seats uncontested.
  "Surat": {
    body: "Surat Municipal Corporation (SMC)",
    totalWards: 120,
    lastElection: "February 2021",
    termEnds: "2026",
    electionCommission: "State Election Commission, Gujarat",
    partyTally: [
      { party: "BJP", seats: 120, color: P.BJP },
    ],
    zones: ["Central", "Varachha", "Katargam", "Limbayat", "Udhna", "Athwa", "Rander"],
    wardNote: "48 representative wards shown. BJP won all 120 seats in Feb 2021.",
    wards: [
      // ── Central Zone ──
      w(1,  "Nanpura",           "Central",  "Alpaben Patel",        "BJP"),
      w(2,  "Begampura",         "Central",  "Rajeshbhai Shah",      "BJP"),
      w(3,  "Chowk Bazar",       "Central",  "Maheshbhai Trivedi",   "BJP"),
      w(4,  "Ghod Dod Road",     "Central",  "Priyaben Desai",       "BJP"),
      w(5,  "Athwalines",        "Central",  "Hemant Bosmiya",       "BJP"),
      w(6,  "Adajan A",          "Central",  "Anjali Patel",         "BJP"),
      w(7,  "Vesu",              "Central",  "Sanjayaben Solanki",   "BJP"),
      w(8,  "Pal",               "Central",  "Vikrambhai Patel",     "BJP"),
      // ── Varachha Zone ──
      w(9,  "Varachha A",        "Varachha", "Dharmeshbhai Patel",   "BJP"),
      w(10, "Varachha B",        "Varachha", "Nitaben Shah",         "BJP"),
      w(11, "Varachha C",        "Varachha", "Rajeshbhai Patil",     "BJP"),
      w(12, "Varachha D",        "Varachha", "Savitaben Chauhan",    "BJP"),
      w(13, "Kapodra",           "Varachha", "Meenaben Solanki",     "BJP"),
      w(14, "Kosad",             "Varachha", "Alkaben Trivedi",      "BJP"),
      w(15, "Anjana",            "Varachha", "Kishorbhai Patel",     "BJP"),
      w(16, "Punagam",           "Varachha", "Hemaben Rathod",       "BJP"),
      // ── Katargam Zone ──
      w(17, "Katargam A",        "Katargam", "Jigneshbhai Shah",     "BJP"),
      w(18, "Katargam B",        "Katargam", "Sunilaben Patel",      "BJP"),
      w(19, "Katargam C",        "Katargam", "Rameshbhai Modi",      "BJP"),
      w(20, "Jahangirpura",      "Katargam", "Prabhaben Patel",      "BJP"),
      w(21, "Amroli",            "Katargam", "Bhavaben Trivedi",     "BJP"),
      w(22, "Sachin",            "Katargam", "Nareshbhai Parmar",    "BJP"),
      w(23, "Sarthana",          "Katargam", "Artiben Panchal",      "BJP"),
      w(24, "Kim",               "Katargam", "Ravindrabhai Trivedi", "BJP"),
      // ── Limbayat Zone ──
      w(25, "Limbayat A",        "Limbayat", "Vijaybhai Darji",      "BJP"),
      w(26, "Limbayat B",        "Limbayat", "Sejalben Contractor",  "BJP"),
      w(27, "Lajamni Chowk",     "Limbayat", "Daxaben Patel",        "BJP"),
      w(28, "Bhestan",           "Limbayat", "Priyankaben Desai",    "BJP"),
      w(29, "Majura Gate",       "Limbayat", "Dipak Patel",          "BJP"),
      w(30, "Rander Road",       "Limbayat", "Nileshbhai Dave",      "BJP"),
      w(31, "Umarwada",          "Limbayat", "Sureshbhai Solanki",   "BJP"),
      w(32, "Ichchhapor",        "Limbayat", "Savitaben Machhi",     "BJP"),
      // ── Udhna Zone ──
      w(33, "Udhna A",           "Udhna",    "Kantilaben Bhavsar",   "BJP"),
      w(34, "Udhna B",           "Udhna",    "Shaileshbhai Patel",   "BJP"),
      w(35, "Udhna Darwaja",     "Udhna",    "Minalaben Shah",       "BJP"),
      w(36, "Hazira",            "Udhna",    "Geeta Vasava",         "BJP"),
      // ── Athwa Zone ──
      w(37, "Athwa A",           "Athwa",    "Jayantibhai Patel",    "BJP"),
      w(38, "Athwa B",           "Athwa",    "Harshadbhai Shah",     "BJP"),
      w(39, "Adajan B",          "Athwa",    "Vimlaben Chauhan",     "BJP"),
      w(40, "Piplod",            "Athwa",    "Bhagwandas Patel",     "BJP"),
      // ── Rander Zone ──
      w(41, "Rander A",          "Rander",   "Alkaben Modi",         "BJP"),
      w(42, "Rander B",          "Rander",   "Mayuriben Patel",      "BJP"),
      w(43, "Palsana",           "Rander",   "Rameshbhai Trivedi",   "BJP"),
      w(44, "Olpad",             "Rander",   "Hetalben Patel",       "BJP"),
      w(45, "Kamrej",            "Rander",   "Kishorbhai Shah",      "BJP"),
      w(46, "Mandvi",            "Rander",   "Laxmiben Solanki",     "BJP"),
      w(47, "Surat Rural A",     "Rander",   "Siddhiben Patel",      "BJP"),
      w(48, "Surat Rural B",     "Rander",   "Jyotiben Patel",       "BJP"),
    ],
  },

  // ── Rajkot Municipal Corporation (RMC) ────────────────────────────────────
  // 72 wards · 5 zones · BJP 67, INC 2, Others 3 (Feb 2021)
  "Rajkot": {
    body: "Rajkot Municipal Corporation (RMC)",
    totalWards: 72,
    lastElection: "February 2021",
    termEnds: "2026",
    electionCommission: "State Election Commission, Gujarat",
    partyTally: [
      { party: "BJP",       seats: 67, color: P.BJP },
      { party: "INC",       seats: 2,  color: P.INC },
      { party: "IND/Others",seats: 3,  color: P.IND },
    ],
    zones: ["Central", "East", "West", "North", "South"],
    wardNote: "60 of 72 wards shown across all 5 zones.",
    wards: [
      // ── Central Zone ──
      w(1,  "Rajkot City Centre",    "Central", "Nimisha Savani",       "BJP"),
      w(2,  "Raiya Road",            "Central", "Hareshbhai Patel",     "BJP"),
      w(3,  "Aji Area",              "Central", "Rameshbhai Shah",      "BJP"),
      w(4,  "Race Course",           "Central", "Pragnaben Trivedi",    "BJP"),
      w(5,  "Jawahar Road",          "Central", "Alkaben Modi",         "BJP"),
      w(6,  "Dhebar Road",           "Central", "Daxaben Solanki",      "BJP"),
      w(7,  "Connaught Place",       "Central", "Kiranbhai Bhatt",      "BJP"),
      w(8,  "University Road",       "Central", "Savitaben Rathod",     "BJP"),
      w(9,  "Limda Chowk",           "Central", "Mohammed Dosa",        "INC"),
      w(10, "Bhaktinagar",           "Central", "Nareshbhai Patel",     "BJP"),
      w(11, "Malaviya Nagar",        "Central", "Meenaben Shah",        "BJP"),
      w(12, "Tagore Road",           "Central", "Ashishbhai Patel",     "BJP"),
      // ── East Zone ──
      w(13, "Mavdi",                 "East",    "Priyaben Desai",       "BJP"),
      w(14, "Raiya East",            "East",    "Vikrambhai Chauhan",   "BJP"),
      w(15, "Sattadhar",             "East",    "Dipaben Patel",        "BJP"),
      w(16, "Airport Area",          "East",    "Hemaben Trivedi",      "BJP"),
      w(17, "Nana Mava",             "East",    "Rajeshbhai Patil",     "BJP"),
      w(18, "Kotharia Road",         "East",    "Artiben Panchal",      "BJP"),
      w(19, "Chitra",                "East",    "Jigneshbhai Shah",     "BJP"),
      w(20, "Gondal Road East",      "East",    "Hemant Bosmiya",       "BJP"),
      w(21, "Kalawad Road East",     "East",    "Bhavaben Patel",       "BJP"),
      w(22, "Nirmala Convent Road",  "East",    "Sureshbhai Trivedi",   "BJP"),
      w(23, "New Mavdi",             "East",    "Ramaben Rathod",       "IND"),
      w(24, "Nana Mauva East",       "East",    "Sejalben Shah",        "BJP"),
      // ── West Zone ──
      w(25, "Kalawad Road",          "West",    "Jayshreeben Gajera",   "BJP"),
      w(26, "New Airport Road",      "West",    "Nileshbhai Dave",      "BJP"),
      w(27, "Patel Colony",          "West",    "Ushaben Joshi",        "BJP"),
      w(28, "Yoginagar",             "West",    "Sunilaben Patel",      "BJP"),
      w(29, "New Ring Road",         "West",    "Sanjaybhai Patel",     "BJP"),
      w(30, "Sadguru Nagar",         "West",    "Harshadbhai Shah",     "BJP"),
      w(31, "Industrial Area",       "West",    "Dharmeshbhai Patel",   "BJP"),
      w(32, "Ring Road West",        "West",    "Priyankaben Desai",    "BJP"),
      w(33, "Rajkot Farm",           "West",    "Alkaben Trivedi",      "BJP"),
      w(34, "Karansinhji Road",      "West",    "Vanitaben Thakkar",    "BJP"),
      w(35, "Nana Mauva West",       "West",    "Meenaben Solanki",     "BJP"),
      w(36, "Shapar Road",           "West",    "Vimlaben Chauhan",     "BJP"),
      // ── North Zone ──
      w(37, "Bhavnagar Road",        "North",   "Kantilaben Bhavsar",   "BJP"),
      w(38, "Bhavnagar Road North",  "North",   "Kishoriben Patel",     "BJP"),
      w(39, "150 Feet Ring Road",    "North",   "Rameshbhai Trivedi",   "BJP"),
      w(40, "Nirmala Road",          "North",   "Nilaben Solanki",      "BJP"),
      w(41, "Amin Marg",             "North",   "Rajulaben Chauhan",    "BJP"),
      w(42, "Gondal Road North",     "North",   "Jayantibhai Patel",    "BJP"),
      w(43, "Kothariya",             "North",   "Bhagwandas Patel",     "BJP"),
      w(44, "Rajkot North",          "North",   "Meenaben Desai",       "BJP"),
      w(45, "Gas Bhavan Area",       "North",   "Prabhaben Rathod",     "BJP"),
      w(46, "Bhavnagar Chowk",       "North",   "Rupal Sorathiya",      "IND"),
      w(47, "Sadguru North",         "North",   "Geeta Vasava",         "BJP"),
      w(48, "Kothariya Road",        "North",   "Kishorbhai Modi",      "BJP"),
      // ── South Zone ──
      w(49, "Gondal Road",           "South",   "Dipak Patel",          "BJP"),
      w(50, "Kasturba Road",         "South",   "Manishaben Rathod",    "BJP"),
      w(51, "Kasturba Road South",   "South",   "Hetalben Patel",       "BJP"),
      w(52, "Mavdi South",           "South",   "Savitaben Machhi",     "BJP"),
      w(53, "Pan Dar",               "South",   "Ravindrabhai Patel",   "BJP"),
      w(54, "Kalawad Road South",    "South",   "Navinbhai Patel",      "BJP"),
      w(55, "Shri Vallabh Nagar",    "South",   "Bhavaben Trivedi",     "BJP"),
      w(56, "Ayodhyanagar",          "South",   "Dilipbhai Thakkar",    "BJP"),
      w(57, "Rajkot GIDC",           "South",   "Mohammed Bawa",        "INC"),
      w(58, "Madhapar",              "South",   "Kishorbhai Shah",       "BJP"),
      w(59, "Ghanteshwar",           "South",   "Pragnaben Shah",       "BJP"),
      w(60, "Astron Chowk",          "South",   "Siddhiben Patel",      "BJP"),
    ],
  },
};
